...
from app.dependencies import (
    get_settings, get_concentrated_amm, get_stableswap_amm,
    get_fee_manager, get_pool_manager, get_current_user
)
from app.models.amm import (
    LiquidityPool, PoolType, SwapDirection, SwapRequest,
    LiquidityPosition, PoolMetrics
)
...
async def create_pool(
    ...
    concentrated_amm: Annotated[ConcentratedLiquidityAMM, Depends(get_concentrated_amm)],
    stableswap_amm: Annotated[StableSwapAMM, Depends(get_stableswap_amm)],
    fee_manager: Annotated[DynamicFeeManager, Depends(get_fee_manager)],
