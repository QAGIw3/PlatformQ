...
setup_monitoring(service_name="stream-processing-service")
...
app = FastAPI(
    ...
    description="Real-time stream processing service using Flink, Beam, and Bytewax",
    version="2.0.0",
    lifespan=lifespan
)
