...
Integration hub providing unified API gateway and service mesh capabilities.
...
|----------|-------------|---------|
| SERVICE_NAME | Service identifier | integration-hub-service |
...
# Run container
docker run -p 8000:8000 integration-hub-service:latest
...
# Or using Helm
helm install integration-hub-service ./helm
```
