...
Consolidated machine learning platform supporting MLflow, Ray, Dask, and federated learning
"""
...
setup_monitoring(service_name="ml-platform-service")
...
# Create FastAPI app
app = FastAPI(
    title="Unified ML Platform Service",
    description="Consolidated machine learning platform supporting MLflow, Ray, Dask, and federated learning",
    version="2.0.0",
    lifespan=lifespan
)
