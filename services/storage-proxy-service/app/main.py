"""
Storage Proxy Service with Document Conversion

Unified storage interface with document conversion capabilities.
Provides MinIO object storage, multi-tenancy support, and format conversion.
"""
...
def read_root():
    return {
        ...
        "version": "2.0",
        "features": ["storage", "conversion", "preview", "licensing"]
    }
