...
from .api import lending, auctions, yield_farming, liquidity, analytics, insurance, infrastructure, infrastructure_amm, infrastructure_risk, infrastructure_insurance, staking, vaults, derivatives, compute_defi, compute_amm
...
app.include_router(compute_amm.router, tags=["compute-amm"])
