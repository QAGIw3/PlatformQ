...
from app.core.dependencies import get_ignite_client, get_pulsar_client, get_service_clients
from app.core.events import publish_event, EventType
from app.monitoring import active_strategies, mining_rewards
...
async def register_market_maker(
    user = Depends(lambda: {"user_id": "mock_user", "tenant_id": "mock_tenant"})
) -> Dict[str, Any]:
