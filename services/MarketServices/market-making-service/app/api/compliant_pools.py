...
from app.core.dependencies import get_ignite_client, get_service_clients
from app.core.events import publish_event, EventType
from app.monitoring import pool_operations, liquidity_gauge
from app.config import settings

router = APIRouter()

# Mock compliance levels
...
async def create_compliant_pool(
    ...
    current_user = Depends(lambda: {"user_id": "mock_user", "tenant_id": "mock_tenant"})
) -> Dict[str, Any]:
    """
