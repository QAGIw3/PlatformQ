...
from .trading_risk_network import TradingRiskNetwork
...
from .api.ml_lineage_api import router as ml_lineage_router
from .api.asset_lineage_api import router as asset_lineage_router
...
ml_lineage_tracker = None
asset_lineage_tracker = None
...
async def lifespan(app: FastAPI):
    ...
    global trading_risk_network, ml_lineage_tracker, asset_lineage_tracker
    ...
    # Initialize Digital Asset Lineage Tracker
    asset_lineage_tracker = DigitalAssetLineageTracker(graph_db)
    app.state.asset_lineage_tracker = asset_lineage_tracker
...
app.include_router(trading_risk_api.router, prefix="/api/v1/graph")
app.include_router(ml_lineage_router, prefix="/api/v1/ml-lineage")
app.include_router(asset_lineage_router, prefix="/api/v1/asset-lineage")
