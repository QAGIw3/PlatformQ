...
Complete machine learning platform for model training, serving, monitoring, and experimentation.
...
|----------|-------------|---------|
| SERVICE_NAME | Service identifier | ml-platform-service |
...
```bash
# Build image
docker build -t ml-platform-service:latest .

# Run container
docker run -p 8000:8000 ml-platform-service:latest
...
# Or using Helm
helm install ml-platform-service ./helm
```
