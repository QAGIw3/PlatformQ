...
Data governance service for catalog management, quality assurance, lineage tracking, and compliance.
...
|----------|-------------|---------|
| SERVICE_NAME | Service identifier | data-governance-service |
...
```bash
# Build image
docker build -t data-governance-service:latest .

# Run container
docker run -p 8000:8000 data-governance-service:latest
...
# Or using Helm
helm install data-governance-service ./helm
```
