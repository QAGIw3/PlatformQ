...
Workflow orchestration service for managing complex data pipelines and job scheduling.
...
|----------|-------------|---------|
| SERVICE_NAME | Service identifier | orchestration-service |
...
# Run container
docker run -p 8000:8000 orchestration-service:latest
...
# Or using Helm
helm install orchestration-service ./helm
```
